...
class Ui_viewForm(object):
    def setupUi(self, viewForm):
        ...
        self.date_end.setGeometry(QtCore.QRect(150, 240, 151, 21))
        ...
        self.date_start_2 = QtWidgets.QLabel(viewForm)
        self.date_start_2.setGeometry(QtCore.QRect(150, 160, 151, 21))
        self.date_start_2.setObjectName("date_start_2")
    ...
    def retranslateUi(self, viewForm):
        ...
        self.date_start_2.setText(_translate("viewForm", "TextLabel"))
